...
public class CircleButtonText extends TextView {
    ...
    public CircleButtonText(Context context) {
        super(context);
        init(context, null);
    }

    public CircleButtonText(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public CircleButtonText(Context context, AttributeSet attrs, int defStyle) {
